  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 px-4 sm:px-6 lg:px-8 z-10">
        {/* Left Content */}
        <div className="lg:w-1/2 space-y-5 mt-8 lg:mt-0">
          <div className="inline-block text-teal-700 bg-white px-4 py-1.5 rounded-full text-xs font-semibold shadow-sm">
            ⭐ Trusted by 50,000+ Businesses
          </div>

          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
            <span className="text-white">Trusted & Expert Chartered Accountants for </span>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <button className="bg-teal-600 text-white px-6 py-3 rounded-lg text-sm font-semibold hover:bg-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl">
              Book Free Consultation →
            </button>
            <button className="bg-white text-teal-700 border-2 border-white px-6 py-3 rounded-lg text-sm font-semibold hover:bg-teal-50 transition-all duration-200 shadow-lg">
              💬 Chat on WhatsApp
            </button>
          </div>
        </div>
        ...
        {/* Right Form */}
        <div className="w-full max-w-md mx-auto lg:mx-0 bg-gradient-to-br from-white/85 via-teal-50/75 to-blue-50/80 backdrop-blur-md rounded-xl shadow-2xl border border-white/40 p-6 lg:p-7">
